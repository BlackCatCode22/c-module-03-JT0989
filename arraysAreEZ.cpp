// jT 9/9/24
//arrayAreEZ.cpp
// An array is a fixed-size, data structure, that must contain the same data.
...
int main() {
    ...
    cout << "\n Array are easy and fun (up until the thrid dimension)" << endl;
    ...
    cout << "\n the size of our int is: " << sizeof(int) << endl;

    int numOfElementsInLuckyNums = sizeof(luckyNums) / sizeof(int);

    cout << "\n the number of elements in LuckyNums: " << numOfElementsInLuckyNums << endl;
